...
<body>
    <header>
        ...
        <h2 class="text-center text-light">Historial de Bitácora</h2>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['evento_bitacora'] ?></td>
                                    <td><?php echo $row['tabla_bitacora'] ?></td>
                                    <td><?php echo $row['fecha_bitacora'] ?></td>
                                    <td><?php echo $row['accion_bitacora'] ?></td>
                                    <td><?php echo $row['usuario_bitacora'] ?></td>
                                    <td><a href="javascript:void(0)" class="btn btn-danger" id="delete_id" data-id="<?php echo $row['id_bitacora'] ?>">Eliminar</a></td>
                                </tr>
                            <?php
                            }
                            ?>
                        ...
                        $.ajax({
                            ...
                            .done(function(response) {
                                ...
                                Swal({
                                    ...
                                    if (result.value) {
                                        window.location = "Ver_Bitacora.php";
                                    }
                                });
                            })
                            .fail(function() {
