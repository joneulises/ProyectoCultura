                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-4 col-xs-4">
                                                      ...
                                                      <div class="form-group col-sm-6 col-lg-12">
                                                          ...
                                                          <input type="text" name="fnombresala" placeholder="Nombre de sala" class="form-control"> 
                                                          ...
                                                          <div class="form-group col-sm-6 col-lg-12">
                                                              <div class="help-block with-errors"></div>
                                                              <textarea rows="2" name="fcomentario_sala" placeholder="Agrega tu comentario" class="form-control" required data-error="Descripcion de taller"></textarea>
