...
<body>
    ...
    <div class="container">
         <a href="./menu_administrador.php" class="btn btn-primary"><h4> Volver al Menú </h4></a>
         <a href="./FormRegistrarEvento.php" class="btn btn-primary"><h4> Nuevo Evento </h4></a>
        <br>
                        ...
                        <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php  echo $row['id_canton']?></td>     
                                                <td><a href="Actualizar_Evento.php?id=<?php echo $row['id_evento'] ?>" class="btn btn-info" >Editar</a></td>
