            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                        <li><a href="./FormRegistrarTallerista.php">Registar Tallerista</a></li>
        ...
        <div id="content" class="bg-grey w-100">
            ...
            <div class="container">
               <!-- <div class="row">-->
                    ...
                    <form class="popup-form"  action="Update_Horario.php?id=<?php echo $_GET['id']; ?>"  method="POST" id="contactForm" name="contactform" data-toggle="validator">
						<div class="row">
